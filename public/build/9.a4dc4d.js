            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _this.fetchEmployee({
                  ...
                  company_id: parseInt(_this.searchData.company_id),
                  japanese_level: parseInt(_this.searchData.japanese_level),
                  footId: parseInt(_this.searchData.footId),
                  divisionId: parseInt(_this.searchData.divisionId),
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.searchData.company_id,
                          expression: "searchData.company_id"
                        }
                      ],
                      staticClass: "form-control",
                      on: {
                    ...
                    [
                      ...
                      _vm._l(_vm.company, function(item) {
                        return _c("option", { domProps: { value: item } }, [
                          _vm._v(
                            _vm._s(_vm.$t("commons.label_company_name_" + item))
                          )
                        ])
                      })
                    ],
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.searchData.footId,
                          expression: "searchData.footId"
                        }
                      ],
                      staticClass: "form-control",
                      on: {
                  ...
                  _c(
                    ...
                    [
                      ...
                      _vm._l(_vm.divisions, function(item) {
                        return item.parent_id == _vm.searchData.footId
