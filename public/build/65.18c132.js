                ...
                sweetalert2_dist_sweetalert2_js__WEBPACK_IMPORTED_MODULE_2___default.a.fire({
                  ...
                  if (result.value) {
                    _this3.deleteEmployee(employeeId).then(function () {
                      ...
                      sweetalert2_dist_sweetalert2_js__WEBPACK_IMPORTED_MODULE_2___default.a.fire(_this3.$t('popup.label_popup_success_title'), _this3.$t('popup.label_popup_success_text'), 'success');
                    })["catch"](function () {
                      sweetalert2_dist_sweetalert2_js__WEBPACK_IMPORTED_MODULE_2___default.a.fire({
                        icon: 'error',
