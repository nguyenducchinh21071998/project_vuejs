  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_6__["mapGetters"])({
    ...
    dataJoinOut: function dataJoinOut() {
      ...
      if (this.selected === 'Division') {
        if (!this.memberInOut.hasOwnProperty('memberIn')) {
                        ...
                        [
                          _c("CChartLine", {
                            attrs: {
                              ...
                              labels: "indexes",
                              labels: [
                                _vm.$t("chart.month.Jan"),
                                _vm.$t("chart.month.Feb"),
                                _vm.$t("chart.month.Mar"),
                                _vm.$t("chart.month.Apr"),
                                _vm.$t("chart.month.May"),
                                _vm.$t("chart.month.Jun"),
                                _vm.$t("chart.month.Jul"),
                                _vm.$t("chart.month.Aug"),
                                _vm.$t("chart.month.Sep"),
                                _vm.$t("chart.month.Oct"),
                                _vm.$t("chart.month.Nov"),
                                _vm.$t("chart.month.Dec")
                              ]
                            }
                          })
                        ],
