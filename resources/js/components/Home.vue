<template id="user-list">
  <div>
    ...
    <div>
        ...
        <h2 style="margin-top: 40px; text-align: center;">Thêm mới user</h2>
        <form autocomplete="off" @submit.prevent="register" v-if="!success" method="post" style="border: 1px solid white; width: 860px; margin-left: 159px">
            <div class="form-group" v-bind:class="{ 'has-error': error && errors.name }">
                <label for="name">Name</label>
                <input type="text" id="name" class="form-control" placeholder="Nhập name" v-model="name" required>
            ...
            <div class="form-group" v-bind:class="{ 'has-error': error && errors.mobile }">
                ...
                <input type="mobile" id="mobile" class="form-control" placeholder="Nhập số điện thoại" v-model="mobile" required>
                <span class="help-block" v-if="error && errors.mobile">{{ errors.mobile }}</span>
            </div>  

            <div class="form-group" v-bind:class="{ 'has-error': error && errors.address }">
                <label for="address">Địa chỉ</label>
                <input type="address" id="address" class="form-control" placeholder="Nhập địa chỉ" v-model="address" required>
